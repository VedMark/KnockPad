...
{
    _pos_info[1] = QString::number(pos.y() + 1);
    _pos_info[3] = QString::number(pos.x() + 1);
    carriagePos->setText(_pos_info[0] + _pos_info[1] + _pos_info[2] + _pos_info[3]);
    carriagePos->setMinimumSize(carriagePos->sizeHint());
}
