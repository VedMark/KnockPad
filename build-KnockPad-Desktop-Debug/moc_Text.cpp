...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Line_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 20, 12)
    ...
    "Line\0heightChanged\0\0widthChanged\0"
};
...
void Line::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Line::heightChanged)) {
                *result = 0;
            }
        }
        {
            typedef void (Line::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Line::widthChanged)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject Line::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Line.data,
      qt_meta_data_Line,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Line.stringdata))
...
// SIGNAL 0
void Line::heightChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 0, 0);
}

// SIGNAL 1
void Line::widthChanged()
{
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_Text_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
...
void Text::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Text::heightChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Text::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Text.data,
      qt_meta_data_Text,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Text.stringdata))
