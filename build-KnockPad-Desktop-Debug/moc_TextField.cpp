...
QT_MOC_LITERAL(5, 55, 19)
    ...
    "TextField\0currentSizeChanged\0\0size\0"
    "curLineIndexChanged\0curSymbIndexChanged\0"
};
...
void TextField::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->currentSizeChanged((*reinterpret_cast< qint64(*)>(_a[1]))); break;
        case 1: _t->curLineIndexChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->curSymbIndexChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (TextField::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TextField::curLineIndexChanged)) {
                *result = 1;
            }
        }
        {
            typedef void (TextField::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TextField::curSymbIndexChanged)) {
                *result = 2;
            }
        }
    }
...
// SIGNAL 1
void TextField::curLineIndexChanged(int _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void TextField::curSymbIndexChanged(int _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
