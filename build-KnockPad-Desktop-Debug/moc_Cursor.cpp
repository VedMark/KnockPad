...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Cursor_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 38, 12)
    ...
    "Cursor\0currentAddressChanged\0\0address\0"
    "updateCursor\0"
};
...
void Cursor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->currentAddressChanged((*reinterpret_cast< QPoint(*)>(_a[1]))); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Cursor::currentAddressChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Cursor::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Cursor.data,
      qt_meta_data_Cursor,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Cursor.stringdata))
...
// SIGNAL 0
void Cursor::currentAddressChanged(QPoint _t1)
{
